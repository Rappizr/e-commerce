        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-16">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm font-medium text-neutral-700">
              ...
              <li><Link href="/" className="hover:text-neutral-950 transition-colors duration-200">Konfirmasi Pembayaran</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <div className="inline-flex items-center gap-2.5 bg-white px-3 py-2 border border-neutral-200 shadow-sm rounded-[3px]">
              ...
              <div className="border-l border-neutral-200 pl-2.5 leading-tight">
                <p className="text-[9px] uppercase tracking-wider text-neutral-400 font-semibold">Transfer Bank</p>
                <p className="text-xs font-bold text-neutral-900">BCA Virtual Account</p>
              </div>
            </div>

            <p className="text-[11px] text-neutral-500 leading-relaxed">
              Mendukung transfer antar bank & BCA Virtual Account otomatis 24 jam.
            </p>
          </div>

        </div>

        <div className="pt-8 border-t border-neutral-300/70 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] tracking-wider uppercase text-neutral-400">
          <p>© 2026 ALMACO. HAK CIPTA DILINDUNGI UNDANG-UNDANG.</p>
          <div className="flex space-x-6">
            <Link href="/kebijakan-privasi" className="hover:text-neutral-700 transition-colors duration-200">KEBIJAKAN PRIVASI</Link>
            <Link href="/syarat-ketentuan" className="hover:text-neutral-700 transition-colors duration-200">SYARAT & KETENTUAN</Link>
          </div>
        </div>
      </div>
    </footer>
