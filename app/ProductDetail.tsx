              ...
              <div className="flex items-center space-x-3">
                {colors.map((color) => (
                  <button
                    ...
                    className={`w-7 h-7 rounded-full flex items-center justify-center transition-all duration-300 ${selectedColor === color.id
              ...
              <div className="grid grid-cols-4 gap-2">
                {sizes.map((size) => (
                  <button
                    ...
                    className={`py-3 text-xs tracking-wider uppercase transition-all duration-300 border ${selectedSize === size
            ...
            <div className="border-t border-stone-200 pt-4 space-y-3">
              <div className="border-b border-stone-200 pb-3">
                ...
                >
                  ...
                  <svg
                    className={`w-4 h-4 text-stone-500 transition-transform duration-300 ${openAccordion === "details" ? "rotate-180" : ""
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
              ...
              <div className="border-b border-stone-200 pb-3">
                ...
                >
                  ...
                  <svg
                    className={`w-4 h-4 text-stone-500 transition-transform duration-300 ${openAccordion === "shipping" ? "rotate-180" : ""
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
