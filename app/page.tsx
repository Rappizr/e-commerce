...
export default function AlmacoPage() {
  ...
  return (
    <main id="beranda" className="min-h-screen bg-white text-neutral-900 antialiased selection:bg-neutral-900 selection:text-white scroll-smooth">
      <style jsx global>{`
        html {
      ...
      <header className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md border-b border-neutral-100 transition-all duration-300">
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`relative py-2 flex items-center gap-1.5 transition-colors duration-300 ${
                    isActive ? 'font-black text-neutral-950' : 'font-semibold text-neutral-500 hover:text-neutral-900'
                  }`}
                >
                  {Icon && <Icon className={`w-3.5 h-3.5 transition-transform duration-300 ${isActive ? 'scale-110' : ''}`} />}
                  <span>{item.label}</span>
                  <span
                    className={`absolute bottom-0 left-0 w-full h-[2px] bg-neutral-950 transition-all duration-300 ease-out origin-left ${
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-2.5 py-1.5 transition-all duration-200 ${
                      isActive ? 'font-bold text-neutral-950 border-l-2 border-neutral-950 pl-2' : 'font-medium text-neutral-600 pl-0'
                    }`}
                  >
      ...
      <section id="testimoni" className="bg-neutral-50 py-24 border-b border-neutral-200/70 overflow-hidden">
      ...
      <footer className="bg-neutral-50/50 border-t border-neutral-200/70 pt-16 pb-12">
